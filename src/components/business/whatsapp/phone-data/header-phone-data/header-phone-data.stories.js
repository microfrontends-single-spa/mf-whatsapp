...
const SUMMARY = `
    El componente <strong>HEADER-PHONE-DATA</strong> representa la barra superior del lado donde se muestran los contactos del usuario, en él se definen las siguientes <strong>propiedades</strong>`;
